...
<template>
    <footer class="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t border-gray-100 mb-2">
        <!-- Grid -->
        <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
            <div>
                <a class="flex-none text-xl font-semibold text-orange-500 focus:outline-none dark:text-white" href="/" aria-label="Brand">Evertec</a>
            </div>
            <!-- End Col -->
