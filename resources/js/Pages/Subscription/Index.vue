                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr v-for="subscription in subscriptions" :key="subscription.id">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">{{ subscription.site ? subscription.site.name : 'Sin sitio' }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">  {{ subscription.plan.name }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">  {{ subscription.plan.description }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">  {{ subscription.plan.amount }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">  {{ subscription.plan.billing_frequency }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">  {{ subscription.plan.subscription_expiration }}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
