                                        ...
                                        <form class="w-1/2 py-5 space-y-3" @submit.prevent="submit">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <TextInput v-model="form.description" id="description" type="text" class="mt-1 block w-full" autocomplete="description" :placeholder="$t('Description')"/>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                                <div>
                                                    ...
                                                    <input v-model="form.amount" type="number" id="amount" class="w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Amount">
                                                    <InputError class="mt-2" :message="form.errors.amount" />
                                                </div>
                                                <div>
                                                    <InputLabel for="currency" :value="$t('Currency')" />
                                                    <select v-model="form.currency" name="currency" id="currency" class="w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <select v-model="form.billing_frequency" name="billingFrequency" id="billing_frequency" class="w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                                        <option v-for="frequency in billingFrequencies" :key="frequency" :value="frequency">
                                                            {{ $t(frequency) }}
                                                        </option>
                                                    </select>
