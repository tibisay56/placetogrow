                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                            ...
                            <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
                                <form class="w-1/2 py-5 space-y-3" @submit.prevent="submit">
                                    <FileInput name="import" class="block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400
                                                                                file:bg-gray-50 file:border-0 file:me-4 file:py-3 file:px-4
                                                                                 dark:file:bg-neutral-700 dark:file:text-neutral-400"/>
                                    <InputError class="mt-2" :message="form.errors.import" />
                                </form>
                            </div>
                        </div>
                    </div>
