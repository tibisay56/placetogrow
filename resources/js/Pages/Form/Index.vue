                            ...
                            <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                    ...
                                    <tr v-for="form in forms">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $t(form.id) }}</span>
                                            </div>
                                        </td>
                                        <td   class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    <div class="grow">
                                                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{form.name}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $t(form.type.name) }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                        ...
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                ...
                                                <template #content>
                                                    <DropdownLink  :href="route('form.show', form)"> {{ $t('Show') }} </DropdownLink>
                                                    <DropdownLink  :href="route('form.edit', form)"> {{ $t('Edit') }} </DropdownLink>
                                                    <DropdownLink  @success="onDeleteSuccess" :href="route('form.destroy', form)" method="delete" as="button">
                                                        {{ $t('Delete') }}
                                                    </DropdownLink>
                                                </template>
                                            </Dropdown>
