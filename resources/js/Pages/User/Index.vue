                                ...
                                <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                                    ...
                                    <div>
                                        <div class="inline-flex gap-x-2">
                                            ...
                                            <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-orange-500 text-white hover:bg-orange-600 disabled:opacity-50 disabled:pointer-events-none" href="#">
                                    ...
                                    <tr v-for="user in users">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <Dropdown align="right" width="48">
                                                ...
                                                <template #content>
                                                    <DropdownLink :href="route('user.show', user)"> {{ $t('Show') }} </DropdownLink>
                                                    <DropdownLink :href="route('user.edit', user)"> {{ $t('Edit') }} </DropdownLink>
                                                    <DropdownLink @success="onDeleteSuccess" :href="route('user.destroy', user)" method="delete" as="button">
                                                        {{ $t('Delete') }}
                                                    </DropdownLink>
                                                </template>
                                            </Dropdown>
